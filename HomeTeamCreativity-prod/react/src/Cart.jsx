  ...
  const deleteFromCart = (product, order) => {
    fetch("/api/deleteFromCart.php", {
      ...
      body: JSON.stringify({
        ...
        size: product.size,
        price:
          setPrice(product.price, product.product_type, product.size) *
  ...
  return (
    <div className="mycart">
                ...
                <div className="productsCell">
                  ...
                  <h2>
                    <button
                      ...
                      className="CartRemoveProductButton"
                    >
                      Delete
                    </button>
                  </h2>
                  ...
                  <div className="confirmation-modal">
                    <div className="confirmation-dialog">
                      ...
                      <div className="confirmation-buttons">
                        ...
                        <button
                          onClick={() => deleteFromCart(product, order)}
      ...
      <div className="FinalCheckoutButtonPlacement">
        <h1>
          {" "}
          Subtotal: ${(order.total_cost * 1).toFixed(2)}
          {customHighTotal ? (
            <> - ${(order.total_cost * 1 + customHighTotal).toFixed(2)}</>
          ) : (
            <div />
